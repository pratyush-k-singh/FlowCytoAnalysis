"""
LSTM Model Trainer for Light Curve Data

This script loads and preprocesses light curve data for various event types, trains an LSTM model on the data, 
...
Functions:
    ...
    build_model(input_shape, num_classes): Builds and compiles an LSTM model.
