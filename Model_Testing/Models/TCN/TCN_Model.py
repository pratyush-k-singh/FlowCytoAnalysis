...
def build_model(input_shape, num_classes):
    """
    Build and compile a TCN model using keras_tcn.
    ...
    Returns:
        Sequential: The compiled TCN model.
    """
    model = Sequential()
    model.add(Input(shape=input_shape))
    model.add(TCN(64, kernel_size=3, dilations=[1, 2, 4, 8], return_sequences=True))
    model.add(TCN(64, kernel_size=3, dilations=[1, 2, 4, 8], return_sequences=False))
